...
# Rates), the formula for calculating your maximum_sum heart rate in beats per minute is 220
# minus your age in years. Your target heart rate is 50–85% of your maximum_sum heart rate.
# Write a script that prompts for and inputs the user’s age and calculates and displays the
# user’s maximum_sum heart rate and the range of the user’s target heart rate. [These formulas
# are estimates provided by the AHA; maximum_sum and target heart rates may vary based on
